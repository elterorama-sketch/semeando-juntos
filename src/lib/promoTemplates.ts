...
export const PROMO_TEMPLATES: ((ctx: PromoTemplateContext) => string)[] = [
  ...
  (ctx) =>
    join([
      ...
      drawLine(ctx),
      "",
      "A arrecadação ajuda os varões do nosso campo a irem ao:",
      ...congressBlock(),
      "",
  ...
  (ctx) =>
    join([
      ...
      "",
      "Toda a renda ajuda os homens do campo a participarem do:",
      ...congressBlock(),
      "",
  ...
  (ctx) =>
    join([
      ...
      "Cada número é uma semente — e parte da colheita leva nossos varões ao:",
      ...congressBlock(),
  ...
  (ctx) =>
    join([
      ...
      drawLine(ctx),
      "",
      `E o melhor: ajuda a levar os varões do campo ao ${VAROES_CONGRESS.title.split("—")[0].trim()}`,
  ...
  (ctx) =>
    join([
      ...
      ...prizesLines(ctx).slice(0, 2),
      "",
      `A arrecadação vai ajudar nossos varões a irem ao ${VAROES_CONGRESS.title.split("—")[0].trim()}, dias ${VAROES_CONGRESS.dates}.`,
      "",
  ...
  (ctx) =>
    join([
      ...
      `Número por ${formatCentsBRL(ctx.priceCents)}` + (promoLine(ctx) ? `, ${promoLine(ctx)}` : "."),
      "",
      `Não perde essa — e ainda ajuda os varões a irem ao ${VAROES_CONGRESS.title.split("—")[0].trim()} (${VAROES_CONGRESS.dates}).`,
      "",
  ...
  (ctx) =>
    join([
      ...
      ...prizesLines(ctx).slice(0, 2),
      "",
      `A renda ajuda os varões do campo a participarem do ${VAROES_CONGRESS.title.split("—")[0].trim()}`,
  ...
  (ctx) =>
    join([
      ...
      `Ajuda os varões a irem ao Congresso (${VAROES_CONGRESS.dates}) ⛪`,
      drawLine(ctx),
      "Chama um cooperador! 📲",
    ]),
  ...
  (ctx) =>
    join([
      ...
      drawLine(ctx),
      "",
      `E ajuda os varões do campo a irem ao ${VAROES_CONGRESS.title.split("—")[0].trim()}!`,
      "",
  ...
  (ctx) =>
    join([
      ...
      "Toda a arrecadação ajuda os varões da nossa igreja a irem ao:",
      ...congressBlock(),
      "",
